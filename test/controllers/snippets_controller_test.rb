...
class SnippetsControllerTest < ActionController::TestCase
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post :create, snippet: { content: @snippet.content, language: @snippet.language, title: @snippet.title }
    end
  ...
  test "should update snippet" do
    patch :update, id: @snippet, snippet: { content: @snippet.content, language: @snippet.language, title: @snippet.title }
    assert_redirected_to snippet_path(assigns(:snippet))
  end
